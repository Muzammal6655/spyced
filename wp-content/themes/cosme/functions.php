...
if ( ! defined( 'COSME_THEME_VERSION' ) ) 
	define( 'COSME_THEME_VERSION', '1.1.46' );
 ...
 */
function cosme_set_elementor_defaults() {
	update_option( 'elementor_disable_color_schemes', 'yes' );
	update_option( 'elementor_disable_typography_schemes', 'yes' );
	update_option( 'elementor_container_width', 1160 );
}
add_action( 'after_switch_theme', 'cosme_set_elementor_defaults' );
 ...
 */
require get_template_directory() . '/includes/theme-dashboard-settings.php';
 ...
 */
function spyced_scripts() {
	wp_enqueue_script('bootstrap-script', get_stylesheet_directory_uri() .'/assets/admin/js/Bootstrap/bootstrap.bundle.min.js', array('jquery'), true);
	wp_enqueue_script('bootstrap-script', get_stylesheet_directory_uri() .'/assets/admin/js/Bootstrap/bootstrap.min.js', array('jquery'), true);
	wp_enqueue_script( 'spyced_scripts_custom', get_template_directory_uri() . '/assets/admin/js/custom.js', array('jquery'), true);
}

add_action( 'wp_enqueue_scripts', 'spyced_scripts' );
function spyced_styles() {
	wp_enqueue_style( 'bootstrap', get_stylesheet_directory_uri() . '/assets/admin/css/Bootstrap/bootstrap.min.css' );
	wp_enqueue_style( 'spyced-styles', get_stylesheet_uri(), array() );
	wp_style_add_data( 'spyced-styles', 'rtl', 'replace' );
}
add_action( 'wp_enqueue_scripts', 'spyced_styles' );
