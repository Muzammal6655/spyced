...
function acoustics_demos_list() {
	...
	$demos = array(
		'cosmetic'      => array(
			...
			'thumbnail'  => 'https://demo.codegearthemes.com/acoustics/clothing/wp-assets/thumb.png',
			'preview'	 => 'https://demo.codegearthemes.com/?id=AWP10001',
			'plugins'    => array_merge(
				array(
					array(
						'name'     => 'Contact Form 7',
			...
			'import'     => array(
				'content'    => 'https://demo.codegearthemes.com/acoustics/clothing/wp-assets/acoustics-clothing.xml',
				'widgets'    => 'https://demo.codegearthemes.com/acoustics/clothing/wp-assets/acoustics-clothing.wie',
				'customizer' => 'https://demo.codegearthemes.com/acoustics/clothing/wp-assets/acoustics-acoustics.dat',
			),
		)
	);
